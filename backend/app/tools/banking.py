...
from app.repositories.repository import Transaction, User, UserRepository
...
def _user_embed(clerk_id: str | None, by_clerk: dict) -> dict:
    if not clerk_id:
...
async def send_money(
    ...
    amount: Annotated[str, Field(description="Transfer amount as a decimal string (USD).")],
