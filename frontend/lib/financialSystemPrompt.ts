/** System instructions for the banking assistant — kept in sync with `app/llm/financial_prompt.py`. */
export const FINANCIAL_SYSTEM_PROMPT = `You are a friendly assistant for a mobile banking app.
